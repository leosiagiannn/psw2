...
<body data-spy="scroll" data-target="#navbar-example" style="background: url('img/keranjang3.jpg') fixed center no-repeat; background-size: cover;">
    ...
    <div style="margin-top: 4px" id="wrapper">
        <div class="panel panel-primary">
            ...
            <form action="" method="post" enctype="multipart/form-data" style="background: url('img/keranjang3.jpg') fixed center no-repeat; background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul_pengumuman" id="judul_pengumuman" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="deskripsi" id="deskripsi" style="height: 100px" required="required"></textarea>
                            </div>
                        </div>
                    </div>
                    <div style="margin-bottom: 10px">
                        <button type="button" class="btn btn-primary" data-dismiss="modal">
                            <a href="pengumuman.php" style="color:white;">
                                Kembali
                            </a>
                        </button>
